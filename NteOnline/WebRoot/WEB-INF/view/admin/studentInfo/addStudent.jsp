...
<body>
    ...
    <li><label>请输入学生姓名：</label>  
    <div class="vocation">
    	<s:textfield name="name" cssClass="dfinput" theme="simple"></s:textfield>
    	
    </div>
      </li>
        <li><label>请输入登录用户名：</label>  
    <div class="vocation">
    	<s:textfield name="username" cssClass="dfinput" theme="simple"></s:textfield>
    	
    </div>
      </li>
       <li><label>请选择班级：</label>  
    <div class="vocation">
    	<s:select list="classes" listKey="id" listValue="courseName" cssClass="select2" theme="simple" name="id"></s:select>
