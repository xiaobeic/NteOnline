...
<body>
    <ul class="toolbar">
      <a href="admin/dudaocourse_adddudaoUI.action">  <li ><span><img src="${pageContext.request.contextPath}/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tbody>
				...
				<s:iterator value="dudaocourse"> 
					<tr>
                					<td>${name }</td>
                						<td><a href="${pageContext.request.contextPath}/admin/dudaocourse_deletedudao.action?id=${id}">删除</a></td>
					</tr>
				</s:iterator>
