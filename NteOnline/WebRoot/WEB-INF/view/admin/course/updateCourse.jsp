...
<body>
    ...
    <ul class="seachform">
      <s:form action="/admin/course_updateCourse.action">
      <s:hidden name="id"></s:hidden>
    <li><label>请输入课程名称：</label>  
    <div class="vocation">
    	<s:textfield name="courseName" cssClass="dfinput" theme="simple"></s:textfield>
    	
    </div>
      </li>
       <li><label>请选择授课教师：</label>  
    <div class="vocation">
    	<s:select name="teacherid" list="teachers" listKey="id" listValue="teacherName" cssClass="select2" theme="simple"></s:select>
