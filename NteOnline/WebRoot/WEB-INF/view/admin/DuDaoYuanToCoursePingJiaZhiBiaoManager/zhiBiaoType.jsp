...
<body>
    	...
    	<ul class="toolbar">
      <a href="admin/dudaoZhiBiao_addTypeUI.action?id=${id }">  <li ><span><img src="${pageContext.request.contextPath}/images/t01.png" /></span>添加</li></a>
        </ul>
    ...
    <table class="tablelist">
        ...
        <tbody>
				...
				<s:iterator value="DTTtypes"> 
					<tr>
                					<td>${name }</td>
                					<td>${score }</td>
                					<td><a href="${pageContext.request.contextPath}/admin/dudaoZhiBiao_updateTypeUI.action?id=${id}">修改</a>
                						<a href="${pageContext.request.contextPath}/admin/dudaoZhiBiao_deleteType.action?id=${id}">删除</a>
                					</td>
					</tr>
				</s:iterator>
