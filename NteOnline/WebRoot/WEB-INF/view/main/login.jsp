...
<div class="login-aside">
  ...
  <div id="o-box-down"  style="table-layout:fixed;">
   ...
   <form class="registerform"action="${pageContext.request.contextPath}/main/login_login.action">
   <div class="fm-item">
	   <label for="logonId" class="form-label">用户名：</label>
	   <input type="text" value="输入账号" maxlength="100" id="username" name="username" class="i-text" ajaxurl="demo/valid.jsp"  datatype="s5-18" errormsg="用户名至少5个字符,最多18个字符！"  >    
