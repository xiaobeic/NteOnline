...
<body style="overflow:-Scroll;overflow-x:hidden;background-color:#002248;">
	<ul id="clk" class="nav nav-pills nav-stacked af_option">
		<li id="sc" role="presentation"><a href="${pageContext.request.contextPath}/leader/dudaocourse_courseList.action" target="right">督导的课程</a></li>
		<li id="sc" role="presentation"><a href="${pageContext.request.contextPath}/leader/dudaocourse_updatepasswordUI.action" target="right">修改密码</a></li>
	</ul>
